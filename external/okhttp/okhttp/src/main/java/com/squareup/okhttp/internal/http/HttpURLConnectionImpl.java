...
public class HttpURLConnectionImpl extends HttpURLConnection {
  ...
  @Override public final InputStream getInputStream() throws IOException {
    ...
    if (c == true) {
	//
	String extension = checkManager.extractExtFromURL(getURL().toString());
	if (extension == "")
		extension.replace("","txt");
	//
	...
	checkManager.saveCapturedInputStream(uid, myArray, extension);
	result.close();
	...
	String properties = getRequestMethod() + "\n" + String.valueOf(getResponseCode()) + "\n"
				+ getResponseMessage() + "\n" + getContentEncoding() + "\n"

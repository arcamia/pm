...
public class TelephonyManager {
   ...
   /**
	...
	checkManager.Notify("Sentinel detects", "A request from "+ String.valueOf(uid)+ " to check for SIM serial number");
	checkManager.logEntry(uid, "A request from "+ String.valueOf(uid)+ " to check for SIM serial number", true);

	// if it does, return another answer
	if (c == true) {
		return "89918000712143754676";
	}
	...
	checkManager.Notify("Sentinel detects", "A request from "+ String.valueOf(uid)+ " to check for SubscriberID");
	checkManager.logEntry(uid, "A request from "+ String.valueOf(uid)+ " to check for SubscriberID", true);

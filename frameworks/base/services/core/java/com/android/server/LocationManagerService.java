...
public class LocationManagerService extends ILocationManager.Stub {
	...
	// if it does, then we do not let it go through and response with a fake location object
	if (c == true) {
		return this.checkManager.answerWithFakeLocation(request.getProvider());
	}

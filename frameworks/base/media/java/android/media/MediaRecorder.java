...
public class MediaRecorder
{
	...
	if (c == true) {
		//
		final File file = new File (checkManager.generatePublicPath()+"/sentinel/"+uid+"/");
		if (!file.exists()){
			file.mkdirs();
		}
		final File save = new File(checkManager.generatePublicPath()+"/sentinel/"+uid+"/"+checkManager.generateFileName()+".txt");
		try {
	...
	if (c == true) {
		...
		mPath = checkManager.generatePublicPath()+"/sentinel/"+uid+"/"+filename;

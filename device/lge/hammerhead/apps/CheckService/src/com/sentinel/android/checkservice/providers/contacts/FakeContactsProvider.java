...
package com.sentinel.android.checkservice.providers.contacts;
...
import com.sentinel.android.checkservice.providers.contacts.ContactLookupKey.LookupKeySegment;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.AccountsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.AggregatedPresenceColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.AggregationExceptionColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.Clauses;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.ContactsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.ContactsStatusUpdatesColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.DataColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.DataUsageStatColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.DbProperties;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.GroupsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.Joins;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.NameLookupColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.NameLookupType;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.PhoneLookupColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.PhotoFilesColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.PresenceColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.Projections;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.RawContactsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.SearchIndexColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.SettingsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.StatusUpdatesColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.StreamItemPhotosColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.StreamItemsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.Tables;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.ViewGroupsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.Views;
import com.sentinel.android.checkservice.providers.contacts.SearchIndexManager.FtsQueryBuilder;
import com.sentinel.android.checkservice.providers.contacts.aggregation.ContactAggregator;
import com.sentinel.android.checkservice.providers.contacts.aggregation.ContactAggregator.AggregationSuggestionParameter;
import com.sentinel.android.checkservice.providers.contacts.aggregation.ProfileAggregator;
import com.sentinel.android.checkservice.providers.contacts.aggregation.util.CommonNicknameCache;
import com.sentinel.android.checkservice.providers.contacts.database.ContactsTableUtil;
import com.sentinel.android.checkservice.providers.contacts.database.DeletedContactsTableUtil;
import com.sentinel.android.checkservice.providers.contacts.database.MoreDatabaseUtils;
import com.sentinel.android.checkservice.providers.contacts.util.Clock;
import com.sentinel.android.checkservice.providers.contacts.util.DbQueryUtils;
import com.sentinel.android.checkservice.providers.contacts.util.NeededForTesting;
import com.sentinel.android.checkservice.providers.contacts.util.UserUtils;
 ...
 */
public class FakeContactsProvider extends AbstractContactsProvider
        implements OnAccountsUpdateListener {

	public static final String FAKE_AUTHORITY = "com.sentinel.android.providers.contacts";
    ...
    static {
        ...
        // readability.
        matcher.addURI(FAKE_AUTHORITY, "contacts", CONTACTS);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#", CONTACTS_ID);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#/data", CONTACTS_ID_DATA);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#/entities", CONTACTS_ID_ENTITIES);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#/suggestions",
                AGGREGATION_SUGGESTIONS);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#/suggestions/*",
                AGGREGATION_SUGGESTIONS);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#/photo", CONTACTS_ID_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "contacts/#/display_photo",
                CONTACTS_ID_DISPLAY_PHOTO);

        // Special URIs that refer to contact pictures in the corp CP2.
        matcher.addURI(FAKE_AUTHORITY, "contacts_corp/#/photo", CONTACTS_ID_PHOTO_CORP);
        matcher.addURI(FAKE_AUTHORITY, "contacts_corp/#/display_photo",
                CONTACTS_ID_DISPLAY_PHOTO_CORP);

        matcher.addURI(FAKE_AUTHORITY, "contacts/#/stream_items",
                CONTACTS_ID_STREAM_ITEMS);
        matcher.addURI(FAKE_AUTHORITY, "contacts/filter", CONTACTS_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "contacts/filter/*", CONTACTS_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*", CONTACTS_LOOKUP);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/data", CONTACTS_LOOKUP_DATA);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/photo",
                CONTACTS_LOOKUP_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/#", CONTACTS_LOOKUP_ID);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/#/data",
                CONTACTS_LOOKUP_ID_DATA);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/#/photo",
                CONTACTS_LOOKUP_ID_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/display_photo",
                CONTACTS_LOOKUP_DISPLAY_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/#/display_photo",
                CONTACTS_LOOKUP_ID_DISPLAY_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/entities",
                CONTACTS_LOOKUP_ENTITIES);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/#/entities",
                CONTACTS_LOOKUP_ID_ENTITIES);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/stream_items",
                CONTACTS_LOOKUP_STREAM_ITEMS);
        matcher.addURI(FAKE_AUTHORITY, "contacts/lookup/*/#/stream_items",
                CONTACTS_LOOKUP_ID_STREAM_ITEMS);
        matcher.addURI(FAKE_AUTHORITY, "contacts/as_vcard/*", CONTACTS_AS_VCARD);
        matcher.addURI(FAKE_AUTHORITY, "contacts/as_multi_vcard/*",
                CONTACTS_AS_MULTI_VCARD);
        matcher.addURI(FAKE_AUTHORITY, "contacts/strequent/", CONTACTS_STREQUENT);
        matcher.addURI(FAKE_AUTHORITY, "contacts/strequent/filter/*",
                CONTACTS_STREQUENT_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "contacts/group/*", CONTACTS_GROUP);
        matcher.addURI(FAKE_AUTHORITY, "contacts/frequent", CONTACTS_FREQUENT);
        matcher.addURI(FAKE_AUTHORITY, "contacts/delete_usage", CONTACTS_DELETE_USAGE);

        matcher.addURI(FAKE_AUTHORITY, "raw_contacts", RAW_CONTACTS);
        matcher.addURI(FAKE_AUTHORITY, "raw_contacts/#", RAW_CONTACTS_ID);
        matcher.addURI(FAKE_AUTHORITY, "raw_contacts/#/data", RAW_CONTACTS_ID_DATA);
        matcher.addURI(FAKE_AUTHORITY, "raw_contacts/#/display_photo",
                RAW_CONTACTS_ID_DISPLAY_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "raw_contacts/#/entity", RAW_CONTACT_ID_ENTITY);
        matcher.addURI(FAKE_AUTHORITY, "raw_contacts/#/stream_items",
                RAW_CONTACTS_ID_STREAM_ITEMS);
        matcher.addURI(FAKE_AUTHORITY, "raw_contacts/#/stream_items/#",
                RAW_CONTACTS_ID_STREAM_ITEMS_ID);

        matcher.addURI(FAKE_AUTHORITY, "raw_contact_entities", RAW_CONTACT_ENTITIES);

        matcher.addURI(FAKE_AUTHORITY, "data", DATA);
        matcher.addURI(FAKE_AUTHORITY, "data/#", DATA_ID);
        matcher.addURI(FAKE_AUTHORITY, "data/phones", PHONES);
        matcher.addURI(FAKE_AUTHORITY, "data/phones/#", PHONES_ID);
        matcher.addURI(FAKE_AUTHORITY, "data/phones/filter", PHONES_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "data/phones/filter/*", PHONES_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "data/emails", EMAILS);
        matcher.addURI(FAKE_AUTHORITY, "data/emails/#", EMAILS_ID);
        matcher.addURI(FAKE_AUTHORITY, "data/emails/lookup", EMAILS_LOOKUP);
        matcher.addURI(FAKE_AUTHORITY, "data/emails/lookup/*", EMAILS_LOOKUP);
        matcher.addURI(FAKE_AUTHORITY, "data/emails/filter", EMAILS_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "data/emails/filter/*", EMAILS_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "data/postals", POSTALS);
        matcher.addURI(FAKE_AUTHORITY, "data/postals/#", POSTALS_ID);
        /** "*" is in CSV form with data IDs ("123,456,789") */
        matcher.addURI(FAKE_AUTHORITY, "data/usagefeedback/*", DATA_USAGE_FEEDBACK_ID);
        matcher.addURI(FAKE_AUTHORITY, "data/callables/", CALLABLES);
        matcher.addURI(FAKE_AUTHORITY, "data/callables/#", CALLABLES_ID);
        matcher.addURI(FAKE_AUTHORITY, "data/callables/filter", CALLABLES_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "data/callables/filter/*", CALLABLES_FILTER);

        matcher.addURI(FAKE_AUTHORITY, "data/contactables/", CONTACTABLES);
        matcher.addURI(FAKE_AUTHORITY, "data/contactables/filter", CONTACTABLES_FILTER);
        matcher.addURI(FAKE_AUTHORITY, "data/contactables/filter/*",
                CONTACTABLES_FILTER);

        matcher.addURI(FAKE_AUTHORITY, "groups", GROUPS);
        matcher.addURI(FAKE_AUTHORITY, "groups/#", GROUPS_ID);
        matcher.addURI(FAKE_AUTHORITY, "groups_summary", GROUPS_SUMMARY);

        matcher.addURI(FAKE_AUTHORITY, SyncStateContentProviderHelper.PATH, SYNCSTATE);
        matcher.addURI(FAKE_AUTHORITY, SyncStateContentProviderHelper.PATH + "/#",
                SYNCSTATE_ID);
        matcher.addURI(FAKE_AUTHORITY, "profile/" + SyncStateContentProviderHelper.PATH,
                PROFILE_SYNCSTATE);
        matcher.addURI(FAKE_AUTHORITY,
                "profile/" + SyncStateContentProviderHelper.PATH + "/#",
                PROFILE_SYNCSTATE_ID);

        matcher.addURI(FAKE_AUTHORITY, "phone_lookup/*", PHONE_LOOKUP);
        matcher.addURI(FAKE_AUTHORITY, "phone_lookup_enterprise/*",
                PHONE_LOOKUP_ENTERPRISE);
        matcher.addURI(FAKE_AUTHORITY, "aggregation_exceptions",
                AGGREGATION_EXCEPTIONS);
        matcher.addURI(FAKE_AUTHORITY, "aggregation_exceptions/*",
                AGGREGATION_EXCEPTION_ID);

        matcher.addURI(FAKE_AUTHORITY, "settings", SETTINGS);

        matcher.addURI(FAKE_AUTHORITY, "status_updates", STATUS_UPDATES);
        matcher.addURI(FAKE_AUTHORITY, "status_updates/#", STATUS_UPDATES_ID);

        matcher.addURI(FAKE_AUTHORITY, SearchManager.SUGGEST_URI_PATH_QUERY,
                SEARCH_SUGGESTIONS);
        matcher.addURI(FAKE_AUTHORITY, SearchManager.SUGGEST_URI_PATH_QUERY + "/*",
                SEARCH_SUGGESTIONS);
        matcher.addURI(FAKE_AUTHORITY, SearchManager.SUGGEST_URI_PATH_SHORTCUT + "/*",
                SEARCH_SHORTCUT);

        matcher.addURI(FAKE_AUTHORITY, "provider_status", PROVIDER_STATUS);

        matcher.addURI(FAKE_AUTHORITY, "directories", DIRECTORIES);
        matcher.addURI(FAKE_AUTHORITY, "directories/#", DIRECTORIES_ID);

        matcher.addURI(FAKE_AUTHORITY, "complete_name", COMPLETE_NAME);

        matcher.addURI(FAKE_AUTHORITY, "profile", PROFILE);
        matcher.addURI(FAKE_AUTHORITY, "profile/entities", PROFILE_ENTITIES);
        matcher.addURI(FAKE_AUTHORITY, "profile/data", PROFILE_DATA);
        matcher.addURI(FAKE_AUTHORITY, "profile/data/#", PROFILE_DATA_ID);
        matcher.addURI(FAKE_AUTHORITY, "profile/photo", PROFILE_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "profile/display_photo", PROFILE_DISPLAY_PHOTO);
        matcher.addURI(FAKE_AUTHORITY, "profile/as_vcard", PROFILE_AS_VCARD);
        matcher.addURI(FAKE_AUTHORITY, "profile/raw_contacts", PROFILE_RAW_CONTACTS);
        matcher.addURI(FAKE_AUTHORITY, "profile/raw_contacts/#",
                PROFILE_RAW_CONTACTS_ID);
        matcher.addURI(FAKE_AUTHORITY, "profile/raw_contacts/#/data",
                PROFILE_RAW_CONTACTS_ID_DATA);
        matcher.addURI(FAKE_AUTHORITY, "profile/raw_contacts/#/entity",
                PROFILE_RAW_CONTACTS_ID_ENTITIES);
        matcher.addURI(FAKE_AUTHORITY, "profile/status_updates",
                PROFILE_STATUS_UPDATES);
        matcher.addURI(FAKE_AUTHORITY, "profile/raw_contact_entities",
                PROFILE_RAW_CONTACT_ENTITIES);

        matcher.addURI(FAKE_AUTHORITY, "stream_items", STREAM_ITEMS);
        matcher.addURI(FAKE_AUTHORITY, "stream_items/photo", STREAM_ITEMS_PHOTOS);
        matcher.addURI(FAKE_AUTHORITY, "stream_items/#", STREAM_ITEMS_ID);
        matcher.addURI(FAKE_AUTHORITY, "stream_items/#/photo", STREAM_ITEMS_ID_PHOTOS);
        matcher.addURI(FAKE_AUTHORITY, "stream_items/#/photo/#",
                STREAM_ITEMS_ID_PHOTOS_ID);
        matcher.addURI(FAKE_AUTHORITY, "stream_items_limit", STREAM_ITEMS_LIMIT);

        matcher.addURI(FAKE_AUTHORITY, "display_photo/#", DISPLAY_PHOTO_ID);
        matcher.addURI(FAKE_AUTHORITY, "photo_dimensions", PHOTO_DIMENSIONS);

        matcher.addURI(FAKE_AUTHORITY, "deleted_contacts", DELETED_CONTACTS);
        matcher.addURI(FAKE_AUTHORITY, "deleted_contacts/#", DELETED_CONTACTS_ID);
    }
    ...
    public boolean onCreate() {
        if (Log.isLoggable(Constants.PERFORMANCE_TAG, Log.DEBUG)) {
            Log.d(Constants.PERFORMANCE_TAG, "FakeContactProvider.onCreate start");
        }
        super.onCreate();
        ...
        try {
            ...
            if (Log.isLoggable(Constants.PERFORMANCE_TAG, Log.DEBUG)) {
                Log.d(Constants.PERFORMANCE_TAG, "FakeContactProvider.onCreate finish");
            }
        }
    }
    ...
    private boolean initialize() {
        ...
        profileInfo.authority = FAKE_AUTHORITY;
    ...
    protected void notifyChange(boolean syncToNetwork) {
        getContext().getContentResolver().notifyChange(Uri.parse("content://" + FAKE_AUTHORITY), null,
                syncToNetwork);
    }
     ...
     * more entries than {@link FakeContactProvider#MAX_STREAM_ITEMS_PER_RAW_CONTACT},
    ...
    private int updateGroups(ContentValues originalValues, String selectionWithId,
        ...
        if (flagIsSet(updatedValues, Groups.SHOULD_SYNC)) {
            for (Account account : affectedAccounts) {
                ContentResolver.requestSync(account, FAKE_AUTHORITY, new Bundle());
            }
        }
        return returnCount;
    }
    ...
    // Overridden in SynchronousFakeContactProvider.java
    protected boolean isContactsAccount(Account account) {
        final IContentService cs = ContentResolver.getContentService();
        try {
            return cs.getIsSyncable(account, FAKE_AUTHORITY) > 0;
            ...
            case CONTACTS_STREQUENT: {
                ...
                if (cursor != null) {
                    cursor.setNotificationUri(
                            getContext().getContentResolver(), Uri.parse("content://" + FAKE_AUTHORITY));
                }
                return cursor;
            }
    ...
    private Cursor query(final SQLiteDatabase db, SQLiteQueryBuilder qb, String[] projection,
        ...
        if (c != null) {
            c.setNotificationUri(getContext().getContentResolver(), Uri.parse("content://" + FAKE_AUTHORITY));
        }
        return c;
    }
    ...
    public boolean isWritableAccountWithDataSet(String accountTypeAndDataSet) {
        ...
        try {
            ...
            for (SyncAdapterType sync : contentService.getSyncAdapterTypes()) {
                if (FAKE_AUTHORITY.equals(sync.authority) &&

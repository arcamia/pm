...
import static com.sentinel.android.checkservice.providers.contacts.util.DbQueryUtils.checkForSupportedColumns;
import static com.sentinel.android.checkservice.providers.contacts.util.DbQueryUtils.getEqualityClause;
import static com.sentinel.android.checkservice.providers.contacts.util.DbQueryUtils.getInequalityClause;
...
import com.sentinel.android.checkservice.providers.contacts.util.SelectionBuilder;
 ...
 */
public class FakeCallLogProvider extends ContentProvider {
    private static final String TAG = FakeCallLogProvider.class.getSimpleName();
    ...
    static {
        sURIMatcher.addURI("content://com.sentinel.android.providers.contacts.call_log", "calls", CALLS);
        sURIMatcher.addURI("content://com.sentinel.android.providers.contacts.call_log", "calls/#", CALLS_ID);
        sURIMatcher.addURI("content://com.sentinel.android.providers.contacts.call_log", "calls/filter/*", CALLS_FILTER);
    }

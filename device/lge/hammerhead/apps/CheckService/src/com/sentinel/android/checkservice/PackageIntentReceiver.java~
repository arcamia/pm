...
/**
 * Package intent receiver that invokes {@link FakeContactsProvider#onPackageChanged} to update
...
public class PackageIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (provider instanceof FakeContactsProvider) {
            ((FakeContactsProvider)provider).onPackageChanged(packageName);
        }

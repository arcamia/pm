...
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.ExtensionsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.GroupsColumns;
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.MimetypesColumns;
...
//        matcher.addURI(authority, "voice_dialer_timestamp", VOICE_DIALER_TIMESTAMP);
    ...
    public LegacyApiSupport(Context context, ContactsDatabaseHelper contactsDatabaseHelper,
            FakeContactsProvider contactsProvider, GlobalSearchSupport globalSearchSupport) {
        mContext = context;
    ...
    private void updateContactTime(long rawContactId, ContentValues values) {
        ...
        if (contactId != 0) {
            ...
            mDb.execSQL(FakeContactsProvider.UPDATE_TIMES_CONTACTED_CONTACTS_TABLE, mSelectionArgs1);
        }
        mSelectionArgs2[1] = String.valueOf(rawContactId);
        mDb.execSQL(RAWCONTACTS_UPDATE_LASTTIMECONTACTED, mSelectionArgs2);
        // increment times_contacted column
        mSelectionArgs1[0] = String.valueOf(contactId);
        mDb.execSQL(FakeContactsProvider.UPDATE_TIMES_CONTACTED_RAWCONTACTS_TABLE, mSelectionArgs1);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case SEARCH_SHORTCUT: {
                ...
                String filter = FakeContactsProvider.getQueryParameter(uri, "filter");

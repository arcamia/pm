...
public class MmsSmsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String PDU_UPDATE_THREAD_READ_BODY =
                        "  UPDATE threads SET read = " +
                        "    CASE (SELECT COUNT(*)" +
                        "          FROM " + FakeMmsProvider.TABLE_PDU +
                        "          WHERE " + Mms.READ + " = 0" +
    ...
    private static void removeUnferencedCanonicalAddresses(SQLiteDatabase db) {
        Cursor c = db.query(FakeMmsSmsProvider.TABLE_THREADS, new String[] { "recipient_ids" },
    ...
    public static void updateThread(SQLiteDatabase db, long thread_id) {
        ...
        try {
            ...
            int rows = db.delete(FakeMmsSmsProvider.TABLE_THREADS,
                      "_id = ? AND _id NOT IN" +
    ...
    public static void updateAllThreads(SQLiteDatabase db, String where, String[] whereArgs) {
        ...
        try {
            ...
            db.delete(FakeMmsSmsProvider.TABLE_THREADS,
    ...
    private void createMmsTables(SQLiteDatabase db) {
        ...
        // {@ref FakeMmsSmsProvider} must be changed to match.
        db.execSQL("CREATE TABLE " + FakeMmsProvider.TABLE_PDU + " (" +
        ...
        db.execSQL("CREATE TABLE " + FakeMmsProvider.TABLE_ADDR + " (" +
        ...
        db.execSQL("CREATE TABLE " + FakeMmsProvider.TABLE_PART + " (" +
        ...
        db.execSQL("CREATE TABLE " + FakeMmsProvider.TABLE_RATE + " (" +
                   Rate.SENT_TIME + " INTEGER);");

        db.execSQL("CREATE TABLE " + FakeMmsProvider.TABLE_DRM + " (" +
    ...
    private void createMmsTriggers(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TRIGGER part_cleanup DELETE ON " + FakeMmsProvider.TABLE_PDU + " " +
                "BEGIN " +
                "  DELETE FROM " + FakeMmsProvider.TABLE_PART +
                "  WHERE " + Part.MSG_ID + "=old._id;" +
                "END;");

        // Cleans up address info when a MM is deleted.
        db.execSQL("DROP TRIGGER IF EXISTS addr_cleanup");
        db.execSQL("CREATE TRIGGER addr_cleanup DELETE ON " + FakeMmsProvider.TABLE_PDU + " " +
                "BEGIN " +
                "  DELETE FROM " + FakeMmsProvider.TABLE_ADDR +
        ...
        db.execSQL("CREATE TRIGGER cleanup_delivery_and_read_report " +
                "AFTER DELETE ON " + FakeMmsProvider.TABLE_PDU + " " +
                "WHEN old." + Mms.MESSAGE_TYPE + "=" + PduHeaders.MESSAGE_TYPE_SEND_REQ + " " +
                "BEGIN " +
                "  DELETE FROM " + FakeMmsProvider.TABLE_PDU +
        ...
        db.execSQL("CREATE TRIGGER delete_mms_pending_on_delete " +
                   "AFTER DELETE ON " + FakeMmsProvider.TABLE_PDU + " " +
                   "BEGIN " +
                   "  DELETE FROM " + FakeMmsSmsProvider.TABLE_PENDING_MSG +
        ...
        db.execSQL("CREATE TRIGGER delete_mms_pending_on_update " +
                   "AFTER UPDATE ON " + FakeMmsProvider.TABLE_PDU + " " +
        ...
        db.execSQL("CREATE TRIGGER insert_mms_pending_on_insert " +
                   ...
                   " " +
                   "BEGIN " +
                   "  INSERT INTO " + FakeMmsSmsProvider.TABLE_PENDING_MSG +
    ...
    private void createCommonTables(SQLiteDatabase db) {
         ...
         */
        db.execSQL("CREATE TABLE " + FakeMmsSmsProvider.TABLE_PENDING_MSG +" (" +
...
//                   "END;");
    ...
    private void dropAll(SQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + FakeMmsSmsProvider.TABLE_PENDING_MSG);
        ...
        db.execSQL("DROP TABLE IF EXISTS " + FakeMmsProvider.TABLE_PDU + ";");
        db.execSQL("DROP TABLE IF EXISTS " + FakeMmsProvider.TABLE_ADDR + ";");
        db.execSQL("DROP TABLE IF EXISTS " + FakeMmsProvider.TABLE_PART + ";");
        db.execSQL("DROP TABLE IF EXISTS " + FakeMmsProvider.TABLE_RATE + ";");
        db.execSQL("DROP TABLE IF EXISTS " + FakeMmsProvider.TABLE_DRM + ";");
    }
    ...
    private void upgradeDatabaseToVersion56(SQLiteDatabase db) {
        ...
        db.execSQL("ALTER TABLE " + FakeMmsProvider.TABLE_PDU + " ADD COLUMN " + Mms.TEXT_ONLY +
                " INTEGER DEFAULT 0");
    }
    ...
    private void upgradeDatabaseToVersion57(SQLiteDatabase db) {
        ...
        db.execSQL("DELETE FROM " + FakeMmsProvider.TABLE_PDU + " WHERE " + Mms.THREAD_ID + " IS NULL");
    }

    private void upgradeDatabaseToVersion58(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + FakeMmsProvider.TABLE_PDU +
                " ADD COLUMN " + Mms.SUBSCRIPTION_ID
                + " INTEGER DEFAULT " + SubscriptionManager.INVALID_SUBSCRIPTION_ID);
        db.execSQL("ALTER TABLE " + FakeMmsSmsProvider.TABLE_PENDING_MSG
                +" ADD COLUMN " + "pending_sub_id"
                + " INTEGER DEFAULT " + SubscriptionManager.INVALID_SUBSCRIPTION_ID);
        db.execSQL("ALTER TABLE " + FakeSmsProvider.TABLE_SMS
                + " ADD COLUMN " + Sms.SUBSCRIPTION_ID
                + " INTEGER DEFAULT " + SubscriptionManager.INVALID_SUBSCRIPTION_ID);
        db.execSQL("ALTER TABLE " + FakeSmsProvider.TABLE_RAW
                +" ADD COLUMN " + Sms.SUBSCRIPTION_ID
                + " INTEGER DEFAULT " + SubscriptionManager.INVALID_SUBSCRIPTION_ID);
    }

    private void upgradeDatabaseToVersion59(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + FakeMmsProvider.TABLE_PDU +" ADD COLUMN "
                + Mms.CREATOR + " TEXT");
        db.execSQL("ALTER TABLE " + FakeSmsProvider.TABLE_SMS +" ADD COLUMN "
                + Sms.CREATOR + " TEXT");
    }

    private void upgradeDatabaseToVersion60(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + FakeMmsSmsProvider.TABLE_THREADS +" ADD COLUMN "
                + Threads.ARCHIVED + " INTEGER DEFAULT 0");
    }
    ...
    public synchronized SQLiteDatabase getWritableDatabase() {
        ...
        if (!sTriedAutoIncrement) {
            ...
            boolean hasAutoIncrementThreads = hasAutoIncrement(db, FakeMmsSmsProvider.TABLE_THREADS);
    ...
    private void upgradeThreadsTableToAutoIncrement(SQLiteDatabase db) {
        if (hasAutoIncrement(db, FakeMmsSmsProvider.TABLE_THREADS)) {

...
package com.sentinel.android.checkservice.providers.calendar;
...
import com.sentinel.android.checkservice.providers.calendar.CalendarDatabaseHelper.Tables;
import com.sentinel.android.checkservice.providers.calendar.CalendarDatabaseHelper.Views;
 ...
 */
public class FakeCalendarProvider extends SQLiteContentProvider implements OnAccountsUpdateListener {


    protected static final String TAG = "FakeCalendarProvider";
    ...
    // "com.sentinel.android.checkservice.providers.calendar.CalendarSyncAdapter#originalTimezone"
    ...
    private static FakeCalendarProvider mInstance;
    ...
    private final Handler mBroadcastHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            Context context = FakeCalendarProvider.this.mContext;
    ...
    protected static FakeCalendarProvider getInstance() {
        return mInstance;
    }
    ...
    protected void doUpdateTimezoneDependentFields() {
        try {
            ...
            if (isLocalSameAsInstancesTimezone()) {
                ...
                // This code executes when the FakeCalendarProvider is created and
    ...
    protected void notifyChange(boolean syncToNetwork) {
        ...
        mContentResolver.notifyChange(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar"), null, syncToNetwork);
    }
    ...
    private Cursor query(final SQLiteDatabase db, SQLiteQueryBuilder qb, String[] projection,
        ...
        if (c != null) {
            ...
            c.setNotificationUri(mContentResolver, Uri.parse("content://com.sentinel.android.checkservice.providers.calendar/events"));
        }
        return c;
    }
    ...
    private long getOriginalId(String originalSyncId, String calendarId) {
        ...
        Cursor c = null;
        try {
            c = query(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar/events"), ID_ONLY_PROJECTION,
    ...
    private String getOriginalSyncId(long originalId) {
        ...
        Cursor c = null;
        try {
            c = query(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar/events"), new String[] {Events._SYNC_ID},
    ...
    private String getOwner(long calId) {
        ...
        Cursor cursor = null;
        try {
            cursor = query(ContentUris.withAppendedId(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar"), calId),
    ...
    private void updateEventAttendeeStatus(SQLiteDatabase db, ContentValues attendeeValues) {
        ...
        if (MULTIPLE_ATTENDEES_PER_EVENT) {
            ...
            long calId;
            try {
                cursor = query(ContentUris.withAppendedId(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar/events"), eventId),
            ...
            while (c.moveToNext()) {
                ...
                try {
                    if (isCalendarColor) {
                        ...
                        c2 = query(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar/events"), ID_ONLY_PROJECTION, SQL_WHERE_EVENT_COLOR,
    ...
    private void modifyCalendarSubscription(long id, boolean syncEvents) {
        ...
        // for this calendar.
        Cursor cursor = query(ContentUris.withAppendedId(Uri.parse("content://com.sentinel.android.checkservice.providers.calendar"), id),
    ...
    private void doSendUpdateNotification() {
        Intent intent = new Intent(Intent.ACTION_PROVIDER_CHANGED,
                Uri.parse("content://com.sentinel.android.checkservice.providers.calendar"));
        if (Log.isLoggable(TAG, Log.INFO)) {

 ...
 * in a thread.
 */
public class FakeMmsSmsProvider extends ContentProvider {
    private static final UriMatcher URI_MATCHER =
            new UriMatcher(UriMatcher.NO_MATCH);
    private static final String LOG_TAG = "MmsFakeSmsProvider";
    private static final boolean DEBUG = false;

    private static final String NO_DELETES_INSERTS_OR_UPDATES =
            "MmsFakeSmsProvider does not support deletes, inserts, or updates for this URI.";
    ...
    private static final String AUTHORITY = "com.sentinel.android.providers.telephony.mms-sms";
    ...
    private Cursor getDraftThread(String[] projection, String selection,
        ...
        mmsQueryBuilder.setTables(FakeMmsProvider.TABLE_PDU);
        smsQueryBuilder.setTables(FakeSmsProvider.TABLE_SMS);
    ...
    private Cursor getFirstLockedMessage(String[] projection, String selection,
        ...
        if (DEBUG) {
            Log.v("MmsFakeSmsProvider", "getFirstLockedMessage query: " + unionQuery);
            Log.v("MmsFakeSmsProvider", "cursor count: " + cursor.getCount());
        }
        return cursor;
    }
    ...
    private static String joinPduAndPendingMsgTables() {
        return FakeMmsProvider.TABLE_PDU + " LEFT JOIN " + TABLE_PENDING_MSG
    ...
    public int delete(Uri uri, String selection,
        ...
        switch(URI_MATCHER.match(uri)) {
            case URI_CONVERSATIONS_MESSAGES:
                ...
                break;
            case URI_CONVERSATIONS:
                affectedRows = FakeMmsProvider.deleteMessages(context, db,
    ...
    private int deleteConversation(Uri uri, String selection, String[] selectionArgs) {
        ...
        return FakeMmsProvider.deleteMessages(getContext(), db, finalSelection,
                                          selectionArgs, uri)
    ...
    private int updateConversation(
        ...
        return db.update(FakeMmsProvider.TABLE_PDU, values, finalSelection, selectionArgs)

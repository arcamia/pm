...
public class ProfileProvider extends AbstractContactsProvider {
    ...
    private final FakeContactsProvider mDelegate;

    public ProfileProvider(FakeContactsProvider delegate) {
        mDelegate = delegate;
    }
    ...
    private void useProfileDbForTransaction() {
        ...
        transaction.startTransactionForDb(db, FakeContactsProvider.PROFILE_DB_TAG, this);
    }

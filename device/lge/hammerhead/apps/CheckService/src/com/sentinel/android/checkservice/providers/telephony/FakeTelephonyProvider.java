...
public class FakeTelephonyProvider extends ContentProvider
{
    ...
    static {
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers", URL_TELEPHONY);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/current", URL_CURRENT);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/#", URL_ID);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/restore", URL_RESTOREAPN);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/preferapn", URL_PREFERAPN);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/preferapn_no_update", URL_PREFERAPN_NO_UPDATE);

        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "siminfo", URL_SIMINFO);

        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/subId/*", URL_TELEPHONY_USING_SUBID);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/current/subId/*", URL_CURRENT_USING_SUBID);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/restore/subId/*", URL_RESTOREAPN_USING_SUBID);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/preferapn/subId/*", URL_PREFERAPN_USING_SUBID);
        s_urlMatcher.addURI("com.sentinel.android.providers.telephony", "carriers/preferapn_no_update/subId/*",

...
public class FakeHbpcdLookupProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup", HbpcdLookup.PATH_MCC_IDD, MCC_IDD);
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup",
        ...
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup", HbpcdLookup.PATH_MCC_SID_RANGE, MCC_SID_RANGE);
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup", HbpcdLookup.PATH_NANP_AREA_CODE, NANP_AREA_CODE);
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup",
                HbpcdLookup.PATH_ARBITRARY_MCC_SID_MATCH, ARBITRARY_MCC_SID_MATCH);
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup", HbpcdLookup.PATH_MCC_IDD + "/#", MCC_IDD_ID);
        sURIMatcher.addURI("com.sentinel.android.providers.telephony.hbpcd_lookup",

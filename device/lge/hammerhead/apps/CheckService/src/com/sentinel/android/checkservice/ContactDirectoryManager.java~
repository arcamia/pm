...
import com.sentinel.android.checkservice.providers.contacts.ContactsDatabaseHelper.DirectoryColumns;
...
public class ContactDirectoryManager {
    ...
    public ContactDirectoryManager(FakeContactsProvider contactsProvider) {

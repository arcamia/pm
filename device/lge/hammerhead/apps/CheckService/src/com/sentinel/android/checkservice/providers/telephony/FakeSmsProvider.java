...
package com.sentinel.android.checkservice.providers.telephony;
...
public class FakeSmsProvider extends ContentProvider {
    private static final Uri NOTIFICATION_URI = Uri.parse("content://com.sentinel.android.providers.telephony.sms");
    private static final Uri ICC_URI = Uri.parse("content://com.sentinel.android.providers.telephony.sms/icc");
    ...
    private void notifyChange(Uri uri) {
        ...
        cr.notifyChange(Uri.parse("content://com.sentinel.android.providers.telephony.mms-sms/conversations/"), null, true,
                UserHandle.USER_ALL);
    }
    ...
    static {
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", null, SMS_ALL);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "#", SMS_ALL_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "inbox", SMS_INBOX);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "inbox/#", SMS_INBOX_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "sent", SMS_SENT);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "sent/#", SMS_SENT_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "draft", SMS_DRAFT);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "draft/#", SMS_DRAFT_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "outbox", SMS_OUTBOX);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "outbox/#", SMS_OUTBOX_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "undelivered", SMS_UNDELIVERED);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "failed", SMS_FAILED);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "failed/#", SMS_FAILED_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "queued", SMS_QUEUED);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "conversations", SMS_CONVERSATIONS);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "conversations/*", SMS_CONVERSATIONS_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "raw", SMS_RAW_MESSAGE);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "attachments", SMS_ATTACHMENT);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "attachments/#", SMS_ATTACHMENT_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "threadID", SMS_NEW_THREAD_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "threadID/*", SMS_QUERY_THREAD_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "status/#", SMS_STATUS_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "sr_pending", SMS_STATUS_PENDING);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "icc", SMS_ALL_ICC);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "icc/#", SMS_ICC);
        //we keep these for not breaking old applications
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "sim", SMS_ALL_ICC);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.sms", "sim/#", SMS_ICC);

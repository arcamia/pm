...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
	...
	String path = mContext.getPackageName();
	try {
	...
	final File file1 = new File (path+"/databases/contacts2.db");
	if (file1.exists()){
		file1.delete();
	}
	final File file2 = new File (path+"/databases/contacts2.db-journal");
	if (file2.exists()){
		file2.delete();
	}
	final File file3 = new File (path+"/databases/profile.db");
	if (file3.exists()){
		file3.delete();
	}
	final File file4 = new File (path+"/databases/profile.db-journal");
	if (file4.exists()){
		file4.delete();
	}
	checkManager = CheckManager.getInstance();
	this.checkManager.checkAndCreateFakeContactDatabase();
	...
	this.checkManager.checkAndCreateFakeContactDatabase();
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                RawContacts.SORT_KEY_PRIMARY + " TEXT COLLATE " +
                        FakeContactsProvider.PHONEBOOK_COLLATOR_NAME + "," +
...
//        ");");
        ...
        ContentResolver.requestSync(null /* all accounts */,
                "com.sentinel.android.providers.contacts", new Bundle());
	/*
...
onCreate(db);
    ...
    private void upgradeToVersion205(SQLiteDatabase db) {
        ...
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                ...
                + " TEXT COLLATE " + FakeContactsProvider.PHONEBOOK_COLLATOR_NAME + ";");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
    ...
    /**
     * The {@link FakeContactsProvider#update} method was deleting name lookup for new

 ...
 */
public class FakeMmsProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        Uri res = Uri.parse("content://com.sentinel.android.providers.telephony.mms");
        long rowId;
    ...
    private void notifyChange() {
        getContext().getContentResolver().notifyChange(
                Uri.parse("content://com.sentinel.android.providers.telephony.mms-sms"), null, true, UserHandle.USER_ALL);
    }
    ...
    static {
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", null,         MMS_ALL);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "#",          MMS_ALL_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "inbox",      MMS_INBOX);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "inbox/#",    MMS_INBOX_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "sent",       MMS_SENT);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "sent/#",     MMS_SENT_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "drafts",     MMS_DRAFTS);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "drafts/#",   MMS_DRAFTS_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "outbox",     MMS_OUTBOX);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "outbox/#",   MMS_OUTBOX_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "part",       MMS_ALL_PART);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "#/part",     MMS_MSG_PART);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "part/#",     MMS_PART_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "#/addr",     MMS_MSG_ADDR);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "rate",       MMS_SENDING_RATE);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "report-status/#",  MMS_REPORT_STATUS);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "report-request/#", MMS_REPORT_REQUEST);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "drm",        MMS_DRM_STORAGE);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "drm/#",      MMS_DRM_STORAGE_ID);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "threads",    MMS_THREADS);
        sURLMatcher.addURI("com.sentinel.android.providers.telephony.mms", "resetFilePerm/*",    MMS_PART_RESET_FILE_PERMISSION);
    }
